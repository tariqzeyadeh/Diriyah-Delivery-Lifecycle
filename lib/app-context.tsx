...
function applyDomLanguage(next: Language) {
...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  return (
    ...
    >
      ...
      {toast && (
        <div
          className="fixed bottom-6 left-1/2 z-[100] -translate-x-1/2 rounded-lg bg-diriyah-primary px-4 py-2.5 text-sm text-white shadow-lg"
          role="status"
        >
          {toast}
        </div>
